...
public class MyResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest req){
		ExceptionResponse expResp=new ExceptionResponse(ex.getMessage(),"Detailed description of message ",new Date());
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ExceptionResponse expResp=new ExceptionResponse("Validation failes", ex.getBindingResult().toString(), new Date());
